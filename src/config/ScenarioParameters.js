...
const PARAMETERS = {
  ...
  customers: {
    ...
    columns: [
      { field: 'Lever_id', type: ['string'] },
      { field: 'Trip_id', type: ['string'] },
      { field: 'Subtrip_source', type: ['string'] },
      { field: 'Subtrip_destination', type: ['string'] },
      { field: 'Number of deliveries', type: ['int'] },
      {
        field: 'Transport mode',
        type: ['enum'],
        enumValues: ['Truck 12-20', 'Truck 34-40', 'Truck 40-44', 'GNC', 'GNV', 'Electric Hybrid', 'Train', 'SeaShip'],
      },
      { field: 'Distance', type: ['number'], minValue: 0 },
      { field: 'Annual_delivery_weight', type: ['number'], minValue: 0 },
