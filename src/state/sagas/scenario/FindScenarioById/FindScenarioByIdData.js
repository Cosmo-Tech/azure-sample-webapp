...
export function * findScenarioByIdData (action) {
  ...
  yield put({ type: SCENARIO_ACTIONS_KEY.SET_CURRENT_SCENARIO, data: { status: SCENARIO_STATUS.LOADING, scenario: null } });
  ...
  yield put({ type: SCENARIO_ACTIONS_KEY.SET_CURRENT_SCENARIO, data: { status: SCENARIO_STATUS.SUCCESS, scenario: data } });
}
