...
import { ErrorBanner, ErrorBoundary, SupersetEmbed } from '@cosmotech/ui';
...
const CurrentScenarioSupersetReport = ({
  ...
  const { currentScenarioData, isSupersetReducerLoading, report, guestToken, options, hasError, errorForBanner } =
