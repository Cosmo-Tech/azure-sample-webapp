...
export const SupersetEmbeddedReport = ({ id }) => {
  ...
  useEffect(() => {
    ...
    embedDashboard({
      id: "272c380b-8824-48fc-a274-aa2fefb1226a", // given by the Superset embedding UI
      // id: "K7yz1EQ106p", // given by the Superset embedding UI
      supersetDomain: "https://superset-kubernetes.cosmotech.com",
      mountPoint: container,
      fetchGuestToken: () => "eyJ[...]", // insert guest token here
  ...
  return <div style={{width: '100%', height: '800px'}} id={elementId}></div>;
