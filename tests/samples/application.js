...
export const DEFAULT_APPLICATION = {
  ...
  roles: {
    ...
    dataset: [ROLES.DATASET.NONE, ROLES.DATASET.VIEWER, ROLES.DATASET.EDITOR, ROLES.DATASET.ADMIN],
  },
  permissions: {
    organization: [
    ...
    dataset: [
      ...
      PERMISSIONS.DATASET.READ_SECURITY,
      PERMISSIONS.DATASET.WRITE,
      PERMISSIONS.DATASET.WRITE_SECURITY,
  ...
  permissionsMapping: {
    ...
    runner: {
      [ROLES.RUNNER.VIEWER]: [PERMISSIONS.RUNNER.READ],
      [ROLES.RUNNER.EDITOR]: [
        PERMISSIONS.RUNNER.READ,
        PERMISSIONS.RUNNER.READ_SECURITY,
        PERMISSIONS.RUNNER.LAUNCH,
    ...
    dataset: {
      [ROLES.DATASET.VIEWER]: [PERMISSIONS.DATASET.READ],
      [ROLES.DATASET.EDITOR]: [PERMISSIONS.DATASET.READ, PERMISSIONS.DATASET.READ_SECURITY, PERMISSIONS.DATASET.WRITE],
      [ROLES.DATASET.ADMIN]: [
        PERMISSIONS.DATASET.READ,
        PERMISSIONS.DATASET.READ_SECURITY,
        PERMISSIONS.DATASET.WRITE,
