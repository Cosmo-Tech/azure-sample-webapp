...
export const GENERIC_SELECTORS = {
  ...
  datasetmanager: {
    ...
    wizard: {
      ...
      azureStorageAccountName: '[data-cy="text-input-azure-storage-account-name"]',
      azureStorageContainerName: '[data-cy="text-input-azure-storage-container-name"]',
      azureStoragePath: '[data-cy="text-input-azure-storage-path"]',
      adtURL: '[data-cy="text-input-adt-url"]',
