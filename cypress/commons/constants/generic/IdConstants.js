...
export const GENERIC_SELECTORS = {
  ...
  datasetmanager: {
    ...
    wizard: {
      ...
      azureStorageAccountName: '[data-cy="text-input-AzureStorage.name"]',
      azureStorageContainerName: '[data-cy="text-input-AzureStorage.location"]',
      azureStoragePath: '[data-cy="text-input-AzureStorage.path"]',
      adtURL: '[data-cy="text-input-ADT.location"]',
