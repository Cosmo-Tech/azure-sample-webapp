...
export const GENERIC_SELECTORS = {
  ...
  scenario: {
    ...
    editDialog: {
      dialog: '[data-cy=edit-scenario-dialog]',
      nameTextField: '[data-cy=edit-scenario-dialog-name-textfield]',
      description: '[data-cy=text-input-edit-scenario-description]',
      newTagTextField: '[id=edit-scenario-tags]',
      tags: '[data-cy^=edit-scenario-tags-tag-]',
      errorLabel: '[id=scenarioName-helper-text]',
      submitButton: '[data-cy=edit-scenario-dialog-submit-button]',
      cancelButton: '[data-cy=edit-scenario-dialog-cancel-button]',
    },
    manager: {
      view: '[data-cy=scenario-manager-view]',
      tabName: '[data-cy="tabs.scenariomanager.key"]',
      batchDeleteButton: '[data-cy=delete-scenario-batch-button]',
      ...
      scenarioRow: '.MuiDataGrid-row[data-id="$SCENARIOID"]',
      scenarioRows: '.MuiDataGrid-row',
      scenarioInfoIcon: '[data-cy=scenario-info-$SCENARIOID]',
      infoTooltip: '[data-cy=scenario-info-popover]',
      infoDescription: '[data-cy=scenario-info-description]',
      infoTags: '[data-cy^=scenario-info-tag-]',
      infoTagByIndex: '[data-cy=scenario-info-tag-$TAGINDEX]',
      columns: {
        name: '[data-field="name"]',
        runType: '[data-field="runType"]',
        runStatus: '[data-field="runStatus"]',
        dataset: '[data-field="dataset"]',
        owner: '[data-field="owner"]',
        created: '[data-field="created"]',
        status: '[data-field="status"]',
        actionMenu: '[data-field="actionMenu"]',
      },
      rowActionMenu: {
        checkboxCell: '[data-field="__check__"]',
        menu: '[role="menu"]',
        editButton: '[data-cy=create-scenario-button]',
        openButton: '[data-cy=open-scenario-button]',
        shareButton: '[data-cy=share-scenario-button]',
        deleteButton: '[data-cy=scenario-delete-menu-item]',
        deleteCancelButton: '[data-cy=delete-scenarios-button1]',
        deleteConfirmButton: '[data-cy=delete-scenarios-button2]',
      },
      scenarioDeleteDialog: {
        body: '[data-cy="delete-scenarios-dialog-body"]',
        items: '[data-cy^=scenario-delete-dialog-body-list-item-]',
      },
  ...
  datasetmanager: {
    ...
    metadata: {
      ...
      deleteTagButton: '.MuiChip-deleteIcon',
    ...
    wizard: {
      ...
      sourceTypeOptionFile: '[data-cy="enum-input-value-tooltip-FileUploadToDataset"]',
