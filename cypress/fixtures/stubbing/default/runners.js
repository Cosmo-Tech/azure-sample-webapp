...
export const DEFAULT_RUNNER = {
  id: 'r-stubbedrnr00',
  name: 'Test Cypress - Stubbed runner 0',
  description: null,
  tags: null,
  parentId: null,
  ...
  runTemplateId: 'etl_with_azure_storage',
  organizationId: 'O-gZYpnd27G7',
  workspaceId: 'W-stbbdbrwry',
  state: null,
  createInfo: { timestamp: 1714487051204, userId: 'dave.lauper@cosmo.local' },
  updateInfo: { timestamp: 1714487051204, userId: 'dave.lauper@cosmo.local' },
  ownerName: 'Dave Lauper',
  solutionName: 'Demo Brewery Solution',
  runTemplateName: null,
  datasetList: null,
  runSizing: null,
  parametersValues: [],
  lastRun: null,
